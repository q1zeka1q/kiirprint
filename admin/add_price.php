...
if (isset($_POST['add_price'])) {
    ...
    $sql = "INSERT INTO visiitkaardid_hinnad (kogus_alates, hind_4_0, hind_4_4) 
            VALUES ('$kogus', '$hind_4_0', '$hind_4_4')";
...
<head>
    ...
    <style>
        /* Используй те же стили, что в твоем edit_price.php */
        ...
        h2 { margin-top: 0; color: #333; border-bottom: 2px solid #28a745; padding-bottom: 10px; font-size: 22px; }
        ...
        .btn-add { background: #28a745; color: white; border: none; padding: 14px; border-radius: 6px; cursor: pointer; font-weight: bold; width: 100%; margin-top: 25px; transition: 0.3s; font-size: 16px; }
...
<body>
    <div class="card">
        ...
        <form method="POST">
            ...
            <input type="number" name="kogus" placeholder="Например: 500" required>
